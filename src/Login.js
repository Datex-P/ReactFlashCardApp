...
onSuccess = (res) => {
  ...
  render() {
    return (
       <ParticleBackground className='au'>
      ...
      borderRadius: '10px', margin: '40px auto'}}>
            ...
            <img src = {flash} alt = 'flashcard' style={{position: 'relative', left: '-179px', top:'-46px',width:'161%'}}/>
            <img src = {flash} alt = 'flashcard' style={{position: 'relative', left: '-177px',top: '-56px', width:'161%'}}/>
            <img src = {flash} alt = 'flashcard' style={{position: 'relative', left: '-179px', top:'-67px', width:'161%'}}/>
        ...
        <div style={{position: 'absolute', top: '600px', width: 'inherit', display: 'flex', justifyContent:'center'}}>
          <GoogleLogin
            ...
            style={{ marginTop: '300px !important', width: '400px', background:'blue !important'}}
            isSignedIn = {true}
          />
        </div>
